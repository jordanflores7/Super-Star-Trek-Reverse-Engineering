[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-22041afd0340ce965d47ae6ef1cefeee28c7c493a6346c4f15d667ab976d596c.svg)](https://classroom.github.com/a/oON3qOYi)
...
Everything above resides in the one binary file, `sst` (actually, it will now be `sst-x86_64` to denote the specific architecture the program will run on). *Note: As of this time, only x86_64 architecture is supported!* The additional file, `sst.txt` is a README file for the game, and it also serves as in-game documentation (It was a neat idea for 1974, actually).
...
2. At least one screenshot of your terminal running the game, with your hacking credit name showing.
3. A writeup with *at a minimum* the following info:
